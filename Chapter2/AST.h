...
public:
  TextExprAST(const std::string &Text) : Text(Text) {}
...
public:
  AssignStatAST(SourceLocation Loc, const std::string &Name,
                std::unique_ptr<ExprAST> Val)
      : StatAST(Loc), Name(Name), Val(std::move(Val)) {}
...
public:
  ReturnStatAST(SourceLocation Loc, std::unique_ptr<ExprAST> Body)
      : StatAST(Loc), Body(std::move(Body)) {}
...
public:
  PrintStatAST(SourceLocation Loc, std::vector<std::unique_ptr<ExprAST>> Texts)
      : StatAST(Loc), Texts(std::move(Texts)) {}
...
public:
  IfStatAST(SourceLocation Loc, std::unique_ptr<ExprAST> IfCondition,
            std::unique_ptr<StatAST> ThenStat,
            std::unique_ptr<StatAST> ElseStat)
      : StatAST(Loc), IfCondition(std::move(IfCondition)),
        ThenStat(std::move(ThenStat)), ElseStat(std::move(ElseStat)) {}
  IfStatAST(SourceLocation Loc, std::unique_ptr<ExprAST> IfCondition,
            std::unique_ptr<StatAST> ThenStat)
      : StatAST(Loc), IfCondition(std::move(IfCondition)),
...
public:
  WhileStatAST(SourceLocation Loc, std::unique_ptr<ExprAST> WhileCondition,
               std::unique_ptr<StatAST> DoStat)
      : StatAST(Loc), WhileCondition(std::move(WhileCondition)),
        DoStat(std::move(DoStat)) {}
...
public:
  /*BlockStatAST(SourceLocation Loc, std::vector<std::unique_ptr<ExprAST>>
     Variables, std::vector<std::unique_ptr<StatAST>> Statements) :
     StatAST(Loc), Variables(std::move(Variables)),
     Statements(std::move(Statements)) {}*/
  BlockStatAST(SourceLocation Loc, std::vector<std::string> Variables,
               std::vector<std::unique_ptr<StatAST>> Statements)
      : StatAST(Loc), Variables(std::move(Variables)),
        Statements(std::move(Statements)) {}
